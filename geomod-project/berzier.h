...
class Berzier {
 ...
 Berzier(const QString &name) : _name(name) {}
 Berzier(Berzier *curve,const QString &name)
   : _name(name),
    _penColor(0,0,0,255),
...
class BerzierConstructor {
 public:
  virtual ~BerzierConstructor() {}
  virtual const QString type() const = 0;
  virtual Berzier *create(const QString &) = 0;
  virtual Berzier *create(Berzier *,const QString &) = 0;
};
